...
Run: python tools/asset_review.py --output /tmp/omacontra-art
...
def scenes():
    ...
    from omacontra.stages.dragon.foundry import Foundry, Hazard, Bolt
    from omacontra.stages.dragon.foundry_art import FoundryRenderer
...
if __name__=='__main__':
    ...
    parser.add_argument('--output',default=str(Path(__file__).resolve().parents[1]/'review'/'asset-quality'))
