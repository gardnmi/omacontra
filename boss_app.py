...
from intro_music import IntroMusic,GAME_TRACKS,UNLOCK_SOUND
from frame_buffer import FrameBuffer
from release_ui import Frontend
...
class BossApp:
    ...
    def start_tide(self):
        ...
        from journey_cinema import JourneyCinema
    ...
    def tick(self):
        ...
        if front:self.music.set_volume(85*front.profile.settings['effects' if self.music.start_effect else 'music']/100)
