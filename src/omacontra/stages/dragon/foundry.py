...
import math
from omacontra.stages.dragon.wyrm_scene import point as dragon_point, MOUTH, EYES
from dataclasses import dataclass
from omacontra.stages.reaper.combat import Fight, segment_hit, segment_box
