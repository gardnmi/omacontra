...
import math
from omacontra.stages.space.finale import ENDING_DURATION, DEPARTURE_DURATION, ENCOUNTER_DURATION
    ...
    def seek(self, t):
        ...
        if self.f:
            ...
            if self.name=='quattro-transform':
                from omacontra.stages.highway.chase_robot import smooth
