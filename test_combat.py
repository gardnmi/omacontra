import unittest
from combat import Fight,Bullet,segment_hit
...
class CombatTests(unittest.TestCase):
    ...
    def test_upward_aim_keeps_running_legs(self):
        from battle_art import hero_frames
        f=Fight();legs=set()
        for _ in range(50):
    ...
    def test_bullets_start_at_rendered_barrel_in_every_pose(self):
        from hero_pose import muzzle_position
    ...
    def test_jump_arm_stays_at_shoulder_while_aiming_and_moving(self):
        from hero_pose import weapon_pose
        for direction in (-1,1):
            f=Fight();f.facing=direction
    ...
    def test_weapon_axis_matches_bullets_at_all_angles(self):
        from hero_pose import weapon_pose, muzzle_position, BARREL_LENGTH
        import math
