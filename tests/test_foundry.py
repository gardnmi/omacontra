...
import unittest
import cairo
from omacontra.stages.dragon.foundry import Foundry, Hazard, rescue_beat, rescue_car, rescue_tobi, CAR_ENTRY, IMPACT, EJECTION, EXPLOSION, RESCUE_END
...
class FoundryTests(unittest.TestCase):
    ...
    def test_center_arena_rescue_keeps_boss_centered_and_landings_safe(self):
        ...
        from omacontra.stages.dragon.foundry import RESCUE_CAR_SCALE
    ...
    def test_harbor_story_targets_the_space_server(self):
        from omacontra.stages.harbor.journey_cinema import HARBOR_LINES
    ...
    def test_fire_and_fan_start_at_live_muzzle(self):
        ...
        f.emit('fan',1)
        self.assertTrue(all((b.x,b.y)==f.dragon_point(*__import__('omacontra.stages.dragon.wyrm_scene',fromlist=['EYES']).EYES[(f.forge_round-1)%2]) for b in f.bolts))
    ...
    def test_cannon_charge_gives_reaction_time_without_tracking(self):
        from omacontra.stages.dragon.foundry import FORGE_WINDUP
    ...
    def test_full_rotation_accelerates_smoothly_with_damage(self):
        from omacontra.stages.dragon.foundry import SHOULDER_CHARGE, SHOULDER_PERIOD
    ...
    def test_each_completed_rotation_speeds_up_even_without_damage(self):
        from omacontra.stages.dragon.foundry import SHOULDER_CHARGE
    ...
    def test_lava_starts_at_collection_and_never_recedes(self):
        from omacontra.stages.dragon.foundry import Pickup, LAVA_TOP
        f=Foundry();f.mount_hp=0;f.forge_timer=999
    ...
    def test_full_encounter_through_normal_controls(self):
        from tools.foundry_playtest import choose
    ...
    def test_air_dash_passes_through_bolts(self):
        from omacontra.stages.dragon.foundry import Bolt
    ...
    def test_no_tutorial_overlays(self):
        ...
        with patch('omacontra.stages.dragon.foundry_art.label') as label:
