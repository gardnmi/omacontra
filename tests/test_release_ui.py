...
class ReleaseTests(unittest.TestCase):
    ...
    def test_music_player_transport_and_parent_menu_restore(self):
        ...
        self.assertNotIn('the-descent.mp3',[t['file'] for t in player.tracks])
        self.assertIn('arcade-armageddon.opus',[t['file'] for t in player.tracks])
        self.assertIn('omacontra-opening-theme.opus',[t['file'] for t in player.tracks])
